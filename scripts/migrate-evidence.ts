...
try{
 ...
 for(const name of ['20260915000300_evidence.sql','20260915000400_evidence_review_indexes.sql','20260915000500_analysis.sql']){const sql=await readFile(`supabase/migrations/${name}`,'utf8'),hash=createHash('sha256').update(sql).digest('hex');
